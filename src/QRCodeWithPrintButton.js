...
import logoImage from "./images /minexx-196-blue.png"; // Ensure this path is correct and the image file exists
import approvedImage from "./images /stamp.svg"; // Ensure this path is correct and the image file exists
import logheader from "./images /Minexx-white.png"; // Ensure this path is correct and the image file exists
